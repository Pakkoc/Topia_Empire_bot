# <a:sd:1462495939058208960> Forge XP 규칙 <a:sd:1462495961178701834>

> ## <a:DH_MINA_04:1462813052138291282> 개요 및 목적
> ```- XP 획득량을 증가/감소시키는 보너스 규칙 설정
> - 특정 시간대, 채널, 역할에 배율 적용
> - 특정 채널/역할에서 XP 획득 차단```
...
> * 텍스트 유형 선택 시 → 모든 채널 표시 (음성 채널 내 텍스트 포함)
...
> * 특정 채널이나 역할에 상시 XP 보너스 적용
> * 역할/채널 구분 없이 가장 높은 배율이 적용됨
> <a:DH_MINA_03:1462813029577130200> 배율 범위: 1초과~10

> ### <a:DH_MINA_03:1462813029577130200> 채널별 배율
> * 특정 채널에서 XP 획득 시 배율 적용
> * 텍스트/음성 채널 모두 설정 가능
> ```활용 예:
> - #자유채팅 채널: 1.5x
> - 🔊일반 음성방: 2x```
...
> ## 3단계: XP 차단 설정
> ### <a:DH_MINA_03:1462813029577130200> XP 차단 개념
> * 특정 채널이나 역할에서 XP 획득을 완전히 차단
> * 봇 명령어 채널, 경고자 역할 등에 활용
> <a:DH_MINA_03:1462813029577130200> 차단된 대상은 XP를 전혀 받지 못함
...
> ## 4단계: 봇 동작 (자동 처리)
> ### <a:DH_MINA_03:1462813029577130200> XP 지급 시 규칙 적용
...
> 3. 배율 확인 (채널/역할 중 최대값)
> 4. 핫타임 확인 (현재 시간 기준)
> 5. 최종 XP = 기본 XP × 배율 × 핫타임```

> ### <a:DH_MINA_03:1462813029577130200> 차단 우선순위
> * 차단 설정이 배율보다 우선 적용
> * 차단된 채널/역할은 배율이 있어도 XP 미지급
...
> - 1. **핫타임**: 특정 시간대에 XP 배율 증가
> - 2. **채널 배율**: 특정 채널에서 XP 보너스 적용
> - 3. **역할 배율**: 특정 역할에 XP 보너스 적용 (VIP 혜택)
> - 4. **채널 차단**: 특정 채널에서 XP 획득 차단
> - 5. **역할 차단**: 특정 역할에 XP 획득 패널티 적용
