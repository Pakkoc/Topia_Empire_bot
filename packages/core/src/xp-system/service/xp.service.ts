...
export class XpService {
  ...
  async grantTextXp(
    ...
    // 2. 핫타임 미적용 시 역할/채널 배율 확인 (가장 높은 배율 적용)
    ...
    return Result.ok({
      ...
      previousLevel,
      xpType: 'text',
      levelUpNotificationEnabled: leveledUp ? settings.textLevelUpNotificationEnabled : undefined,
      levelUpChannelId: leveledUp ? settings.textLevelUpChannelId : undefined,
      levelUpMessage: leveledUp ? settings.textLevelUpMessage : undefined,
  ...
  async grantVoiceXp(
    ...
    return Result.ok({
      ...
      previousLevel,
      xpType: 'voice',
      levelUpNotificationEnabled: leveledUp ? settings.voiceLevelUpNotificationEnabled : undefined,
      levelUpChannelId: leveledUp ? settings.voiceLevelUpChannelId : undefined,
      levelUpMessage: leveledUp ? settings.voiceLevelUpMessage : undefined,
      rolesToAdd: leveledUp ? rolesToAdd : undefined,
      rolesToRemove: leveledUp ? rolesToRemove : undefined,
      channelsToUnlock: leveledUp ? channelsToUnlock : undefined,
    });
