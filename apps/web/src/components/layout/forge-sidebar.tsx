  ...
  return [
    ...
    },
    {
      ...
      children: [
        ...
        { name: "은행", href: "/currency/bank", icon: "solar:bank-linear", iconActive: "solar:bank-bold" },
...
export function ForgeSidebar({ guildId }: SidebarProps) {
  const pathname = usePathname();
  const basePath = `/dashboard/${guildId}/forge`;
    ...
    <aside className="flex h-full w-72 flex-col bg-black/40 backdrop-blur-xl border-r border-white/5">
      ...
      <div className="p-5 border-b border-white/5">
        ...
        <div className="flex items-center gap-3">
          <div className="h-11 w-11 rounded-xl bg-gradient-to-br from-emerald-500/20 to-green-500/20 flex items-center justify-center overflow-hidden">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-white/40">살아있는 커뮤니티</p>
          </div>
        </div>
      </div>
                          ...
                          <li key={child.name}>
                            <NavigationLink
                              ...
                              className={cn(
                                ...
                                isActive(child.href)
                                  ? "bg-gradient-to-r from-emerald-500/20 to-green-500/20 text-white font-medium border border-emerald-500/30"
                                  : "text-white/50 hover:bg-white/5 hover:text-white/80"
                              )}
                            >
                              <Icon
      ...
      <div className="p-4 border-t border-white/5">
        <div className="flex items-center justify-center px-4 py-3 rounded-xl bg-gradient-to-r from-emerald-500/10 to-green-500/10 border border-emerald-500/20">
